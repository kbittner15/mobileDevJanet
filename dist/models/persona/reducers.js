...
export default ((state = initialState, {
  ...
  switch (type) {
    case SET_EMAIL:
      {
        return { ...state,
          email: !!payload ? payload.trim() : payload
        };
      }
    ...
    case STORE_PERSONA:
      {
        return { ...state,
          persona: payload,
          activePersona: !!payload && payload.activePersona
        };
      }
    ...
    case SAVE_ACTIVE_PERSONA_DEMO_MODE:
      {
        return { ...state,
          savedActivePersonaForDemoMode: payload
        };
      }
    ...
    case SAVE_SESSION_DEMO_MODE:
      {
        return { ...state,
          savedSessionForDemoMode: payload
        };
      }
    ...
    case SAVE_BEHAVIOR_REPORTS_SUSTAINED:
      {
        return { ...state,
          behaviorReportsSustained: payload
        };
      }
