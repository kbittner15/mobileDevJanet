 ...
 */
export const isNewUserEmailValid = email =>
  Boolean(isUniversityEmailValid(email) || isCompanyEmailValid(email))

/**
 * Simple Password Validator
 */
export const isPasswordValid = password =>
  Boolean(!!password && typeof password === 'string' && password.length >= 8)

/**
 * Simple Password Repetition Validator
 */
export const doPasswordsMatch = (password, repeated) =>
  Boolean(!!password && password === repeated)
