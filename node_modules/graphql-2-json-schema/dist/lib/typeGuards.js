...
exports.isIntrospectionScalarType = function (type) { return (type.kind === 'SCALAR'); };
exports.isIntrospectionDefaultScalarType = function (type) { return (type.kind === 'SCALAR' && lodash_1.includes(['Boolean', 'String', 'Int', 'Float'], type.name)); };
